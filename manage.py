...
def drive(model_path=None):
    ...
    steering_controller = dk.parts.PCA9685(0)
    ##steering = dk.parts.PWMSteering(controller=steering_controller,
    ##                                left_pulse=441, right_pulse=299)
    steering = dk.parts.PWMSteering(controller=steering_controller,
                                    left_pulse=289, right_pulse=459) ##SunFounder PiCar-V. Commented by abszolut
    
    throttle_controller1 = dk.parts.PCA9685(4)
    throttle_controller2 = dk.parts.PCA9685(5) ##SunFounder PiCar-V back wheels controlled with 2 servo channel. Commented by abszolut
    throttle = dk.parts.PWMThrottle(controller1=throttle_controller1, controller2=throttle_controller2,
                                    max_pulse=4095, zero_pulse=0, min_pulse=100)
